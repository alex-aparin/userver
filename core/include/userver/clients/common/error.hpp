...
#include <userver/clients/common/error_kind.hpp>
...
public:
    TimeoutException(std::string_view message, const common::LocalStats& stats);
...
std::exception_ptr PrepareException(std::error_code ec, std::string_view url, const common::LocalStats& stats);
